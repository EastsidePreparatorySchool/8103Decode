...
/**
 * Right side TeleOp with full anti-push velocity correction.
 * Uses feedforward + feedback for velocity tracking while driving.
 */
@TeleOp(name = "Right Anti-Push TeleOp", group = "TeleOps")
public class RightAntiPushTeleOp extends RightAutoIntakeTeleOp {
    @Override
    ...
    public void initialize() {
        ...
        scheduler.setDefaultCommand(
                ...
                new AntiPushDriveCommand(gamepad1, false)
        );
    }
}
