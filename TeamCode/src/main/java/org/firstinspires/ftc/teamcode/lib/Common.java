...
public class Common {
    ...
    public static double HOOD_INITIAL_POS = 0.4935;
    ...
    public static double CLOSE_RIGHT_FIELD_START_X_IN = 115;
    public static double CLOSE_RIGHT_FIELD_START_Y_IN = 128.25;
    public static double CLOSE_RIGHT_FIELD_START_HEADING_DEG = 180.0;
    public static double LEFT_FIELD_START_X_IN = 57.0;
    public static double LEFT_FIELD_START_Y_IN = 8.25;
    public static double CLOSE_LEFT_FIELD_START_X_IN = 29;
    public static double CLOSE_LEFT_FIELD_START_Y_IN = 135.75;
    public static double CLOSE_LEFT_FIELD_START_HEADING_DEG = 0.0;
    ...
    public static double CLOSE_START_X_IN = CLOSE_RIGHT_FIELD_START_X_IN;
    public static double CLOSE_START_Y_IN = CLOSE_RIGHT_FIELD_START_Y_IN;
    ...
    public static double ACTUAL_TARGET_Y_IN = RIGHT_FIELD_ACTUAL_TARGET_Y_IN;
