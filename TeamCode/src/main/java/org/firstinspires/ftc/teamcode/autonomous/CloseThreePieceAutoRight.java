...
@Autonomous(name = "CloseThreePieceAutoRight", group = "Command")
public class CloseThreePieceAutoRight extends CloseThreePieceAuto {
    @Override
    public void initialize() {
        Common.START_X_IN = Common.CLOSE_RIGHT_FIELD_START_X_IN;
        Common.START_Y_IN = Common.CLOSE_RIGHT_FIELD_START_Y_IN;
        Common.START_HEADING_DEG = Common.CLOSE_RIGHT_FIELD_START_HEADING_DEG;
