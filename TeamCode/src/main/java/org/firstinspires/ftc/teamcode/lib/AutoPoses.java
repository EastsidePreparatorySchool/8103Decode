...
public class AutoPoses {
    ...
    public static Pose RIGHT_BALL1_PICKUP = new Pose(106, 35, 0);
    public static Pose RIGHT_BALL1_PICKUP_CONTROL1 = new Pose(87, 35);
    public static Pose RIGHT_BALL2_PICKUP = new Pose(111, 35);
    public static Pose RIGHT_BALL3_PICKUP = new Pose(116, 35);
    public static Pose RIGHT_SHOT1 = new Pose(80, 18, Math.toRadians(270));
    public static Pose RIGHT_BALL4_PICKUP = new Pose(106, 59, 0);
    public static Pose RIGHT_BALL4_PICKUP_CONTROL1 = new Pose(80, 59);
    public static Pose RIGHT_BALL5_PICKUP = new Pose(111, 59);
    public static Pose RIGHT_BALL6_PICKUP = new Pose(116, 59);
    ...
    public static Pose LEFT_BALL1_PICKUP = new Pose(144 - 106, 35, Math.toRadians(180));
    public static Pose LEFT_BALL1_PICKUP_CONTROL1 = new Pose(144 - 87, 35);
    public static Pose LEFT_BALL2_PICKUP = new Pose(144 - 111, 35);
    public static Pose LEFT_BALL3_PICKUP = new Pose(144 - 116, 35);
    public static Pose LEFT_SHOT1 = new Pose(144 - 80, 18, Math.toRadians(270));
    public static Pose LEFT_BALL4_PICKUP = new Pose(144 - 106, 59, Math.toRadians(180));
    public static Pose LEFT_BALL4_PICKUP_CONTROL1 = new Pose(144 - 80, 59);
    public static Pose LEFT_BALL5_PICKUP = new Pose(144 - 111, 59);
    public static Pose LEFT_BALL6_PICKUP = new Pose(144 - 116, 59);
