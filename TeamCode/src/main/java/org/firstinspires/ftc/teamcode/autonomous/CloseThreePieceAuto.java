...
public class CloseThreePieceAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        new FollowPathCommand(follower, move1),
    ...
    public void buildPaths() {
        Pose start = new Pose(Common.START_X_IN, Common.START_Y_IN);
        Pose end = new Pose(Common.START_X_IN, Common.START_Y_IN - 20);
        move1 = follower.pathBuilder()
                .addPath(new BezierCurve(start, end))
                .setLinearHeadingInterpolation(Common.START_HEADING_DEG, Common.START_HEADING_DEG)
                .build();
    }
}
